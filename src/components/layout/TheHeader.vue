  ...
  <b-navbar type="dark" variant="dark">
    ...
    <b-navbar-nav>
      ...
      <b-nav-item-dropdown text="Categories" right>
        <b-dropdown-item href="#"><router-link to="/expense-categories">Expense Categories</router-link></b-dropdown-item>
        <b-dropdown-item href="#"><router-link to="/income-category">Income Category</router-link></b-dropdown-item>
            </b-nav-item-dropdown>
